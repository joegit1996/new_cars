...
export const brands: Brand[] = [
  { id: "mercedes", name: "Mercedes-Benz", logoUrl: "/images/brands/mercedes.png", modelCount: 11, featured: true, tagline: "The best or nothing", editorial: mercedesEditorial },
  { id: "bmw", name: "BMW", logoUrl: "/images/brands/bmw.png", modelCount: 5, featured: true, tagline: "Sheer driving pleasure" },
  { id: "toyota", name: "Toyota", logoUrl: "/images/brands/toyota.png", modelCount: 5, featured: true, tagline: "Let's go places" },
  { id: "lexus", name: "Lexus", logoUrl: "/images/brands/lexus.png", modelCount: 4 },
  { id: "porsche", name: "Porsche", logoUrl: "/images/brands/porsche.png", modelCount: 4, featured: true, tagline: "There is no substitute" },
  { id: "changan", name: "Changan", logoUrl: "/images/brands/changan.png", modelCount: 4 },
  { id: "haval", name: "Haval", logoUrl: "/images/brands/haval.png", modelCount: 3 },
  { id: "mg", name: "MG", logoUrl: "/images/brands/mg.png", modelCount: 4 },
];
...
export const trims: Trim[] = [
  // --- Mercedes A 200 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/merc-a200.jpg"], variants: [],
  ...
  // --- Mercedes A 250 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/merc-a250.jpg"], variants: [],
  ...
  // --- Mercedes C 200 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/merc-c200.jpg"], variants: [],
  ...
  // --- Mercedes C 300 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/merc-c300.jpg"], variants: [],
  ...
  // --- Mercedes C 43 AMG ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/merc-c43.jpg"], variants: [],
  ...
  // --- Mercedes E 200 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/merc-e200.jpg"], variants: [],
  ...
  // --- Mercedes E 300 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/merc-e300.jpg"], variants: [],
  ...
  // --- Mercedes GLC 200 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/merc-glc200.jpg"], variants: [],
  ...
  // --- Mercedes GLC 300 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/merc-glc300.jpg"], variants: [],
  ...
  // --- Mercedes GLE 450 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/merc-gle450.jpg"], variants: [],
  ...
  // --- Mercedes AMG GLE 53 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/merc-gle53.jpg"], variants: [],
  ...
  // --- BMW 3 Series ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/bmw-3-series.jpg"], variants: [
      { id: "bmw-320i-sport", trimId: "bmw-320i", name: "Sport Line", price: 13500, description: "Sport styling package", images: ["/images/cars/bmw-3-series.jpg"] },
      { id: "bmw-320i-lux", trimId: "bmw-320i", name: "Luxury Line", price: 13800, description: "Premium luxury trim", images: ["/images/cars/bmw-3-series.jpg"] },
    ],
  ...
  },
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/bmw-3-series.jpg"], variants: [
      { id: "bmw-330i-msport", trimId: "bmw-330i", name: "M Sport", price: 16800, description: "M Sport package with enhanced dynamics", images: ["/images/cars/bmw-3-series.jpg"] },
    ],
  ...
  // --- BMW 5 Series ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/bmw-5-series.jpg"], variants: [],
  ...
  // --- BMW X3 ---
  {
    ...
    engineSummary: "2.0L 4-cyl Turbo, 184 hp", horsepower: 184, torque: 300,
    fuelType: FuelType.Petrol, images: ["/images/cars/bmw-x3.jpg"], variants: [],
  ...
  },
  {
    ...
    engineSummary: "2.0L 4-cyl Turbo, 245 hp", horsepower: 245, torque: 400,
    fuelType: FuelType.Petrol, images: ["/images/cars/bmw-x3.jpg"], variants: [
      { id: "bmw-x3-30-msport", trimId: "bmw-x3-30", name: "M Sport", price: 21500, description: "M Sport design package", images: ["/images/cars/bmw-x3.jpg"] },
    ],
  ...
  // --- BMW X5 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/bmw-x5.jpg"], variants: [
      { id: "bmw-x5-40i-msport", trimId: "bmw-x5-40i", name: "M Sport", price: 30000, description: "M Sport package", images: ["/images/cars/bmw-x5.jpg"] },
    ],
  ...
  // --- BMW 4 Series Coupe ---
  {
    ...
    engineSummary: "2.0L 4-cyl Turbo, 184 hp", horsepower: 184, torque: 300,
    fuelType: FuelType.Petrol, images: ["/images/cars/bmw-4-coupe.jpg"], variants: [],
  ...
  // --- Toyota Camry ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/toyota-camry.jpg"], variants: [],
  ...
  // --- Toyota Land Cruiser ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/toyota-lc.jpg"], variants: [],
  ...
  // --- Toyota RAV4 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/toyota-rav4.jpg"], variants: [],
  ...
  },
  {
    ...
    fuelType: FuelType.Hybrid, images: ["/images/cars/toyota-rav4.jpg"], variants: [],
  ...
  // --- Toyota Corolla ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/toyota-corolla.jpg"], variants: [],
  ...
  // --- Toyota Hilux ---
  {
    ...
    fuelType: FuelType.Diesel, images: ["/images/cars/toyota-hilux.jpg"], variants: [],
  ...
  // --- Lexus ES ---
  {
    ...
    engineSummary: "2.5L 4-cyl, 203 hp", horsepower: 203, torque: 250,
    fuelType: FuelType.Petrol, images: ["/images/cars/lexus-es.jpg"], variants: [],
  ...
  },
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/lexus-es.jpg"], variants: [
      { id: "lex-es350-fsport", trimId: "lex-es350", name: "F Sport", price: 17000, description: "F Sport performance styling", images: ["/images/cars/lexus-es.jpg"] },
    ],
  ...
  // --- Lexus RX ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/lexus-rx.jpg"], variants: [
      { id: "lex-rx350-fsport", trimId: "lex-rx350", name: "F Sport", price: 21500, description: "F Sport design", images: ["/images/cars/lexus-rx.jpg"] },
    ],
  ...
  },
  {
    ...
    fuelType: FuelType.Hybrid, images: ["/images/cars/lexus-rx.jpg"], variants: [],
  ...
  // --- Lexus NX ---
  {
    ...
    engineSummary: "2.5L 4-cyl, 203 hp", horsepower: 203, torque: 250,
    fuelType: FuelType.Petrol, images: ["/images/cars/lexus-nx.jpg"], variants: [],
  ...
  },
  {
    ...
    fuelType: FuelType.Hybrid, images: ["/images/cars/lexus-nx.jpg"], variants: [],
  ...
  // --- Lexus IS ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/lexus-is.jpg"], variants: [
      { id: "lex-is300-fsport", trimId: "lex-is300", name: "F Sport", price: 16000, description: "F Sport handling package", images: ["/images/cars/lexus-is.jpg"] },
    ],
  ...
  // --- Porsche 911 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/porsche-911.jpg"], variants: [],
  ...
  // --- Porsche Cayenne ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/porsche-cayenne.jpg"], variants: [],
  ...
  // --- Porsche Macan ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/porsche-macan.jpg"], variants: [],
  ...
  // --- Porsche Taycan ---
  {
    ...
    fuelType: FuelType.Electric, images: ["/images/cars/porsche-taycan.jpg"], variants: [],
  ...
  // --- Changan CS75 Plus ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/changan-cs75.jpg"], variants: [],
  ...
  // --- Changan CS55 Plus ---
  {
    ...
    engineSummary: "1.5L Turbo, 181 hp", horsepower: 181, torque: 300,
    fuelType: FuelType.Petrol, images: ["/images/cars/changan-cs55.jpg"], variants: [],
  ...
  // --- Changan Alsvin ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/changan-alsvin.jpg"], variants: [],
  ...
  // --- Changan Uni-T ---
  {
    ...
    engineSummary: "1.5L Turbo, 181 hp", horsepower: 181, torque: 300,
    fuelType: FuelType.Petrol, images: ["/images/cars/changan-unit.jpg"], variants: [],
  ...
  // --- Haval H6 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/haval-h6.jpg"], variants: [],
  ...
  // --- Haval Jolion ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/haval-jolion.jpg"], variants: [],
  ...
  // --- Haval Dargo ---
  {
    ...
    engineSummary: "2.0L Turbo, 211 hp", horsepower: 211, torque: 325,
    fuelType: FuelType.Petrol, images: ["/images/cars/haval-dargo.jpg"], variants: [],
  ...
  // --- MG HS ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/mg-hs.jpg"], variants: [],
  ...
  // --- MG ZS ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/mg-zs.jpg"], variants: [],
  ...
  // --- MG 5 ---
  {
    ...
    fuelType: FuelType.Petrol, images: ["/images/cars/mg-5.jpg"], variants: [],
  ...
  // --- MG 4 ---
  {
    ...
    fuelType: FuelType.Electric, images: ["/images/cars/mg-4.jpg"], variants: [],
...
export const models: Model[] = [
  ...
  { id: "merc-a200", brandId: "mercedes", name: "A 200", bodyType: BodyType.Hatchback, year: 2026, startingPrice: 11000, trimCount: 1, isNew: false, isUpdated: false, specsSummary: { engineRange: "1.3L", hpRange: "163 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/merc-a200.jpg", segmentOrder: 1, modelFamily: "A-Class" },
  { id: "merc-a250", brandId: "mercedes", name: "A 250", bodyType: BodyType.Hatchback, year: 2026, startingPrice: 13800, trimCount: 1, isNew: false, isUpdated: false, specsSummary: { engineRange: "2.0L", hpRange: "224 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/merc-a250.jpg", segmentOrder: 2, modelFamily: "A-Class" },
  { id: "merc-c200", brandId: "mercedes", name: "C 200", bodyType: BodyType.Sedan, year: 2026, startingPrice: 13500, trimCount: 2, isNew: false, isUpdated: true, specsSummary: { engineRange: "1.5L", hpRange: "204 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/merc-c200.jpg", segmentOrder: 3, modelFamily: "C-Class" },
  { id: "merc-c300", brandId: "mercedes", name: "C 300", bodyType: BodyType.Sedan, year: 2026, startingPrice: 16800, trimCount: 2, isNew: false, isUpdated: true, specsSummary: { engineRange: "2.0L", hpRange: "258 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/merc-c300.jpg", segmentOrder: 4, modelFamily: "C-Class" },
  { id: "merc-c43", brandId: "mercedes", name: "C 43 AMG", bodyType: BodyType.Sedan, year: 2026, startingPrice: 24500, trimCount: 1, isNew: false, isUpdated: false, specsSummary: { engineRange: "2.0L", hpRange: "408 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/merc-c43.jpg", segmentOrder: 5, modelFamily: "C-Class" },
  { id: "merc-e200", brandId: "mercedes", name: "E 200", bodyType: BodyType.Sedan, year: 2026, startingPrice: 18500, trimCount: 2, isNew: true, isUpdated: false, specsSummary: { engineRange: "2.0L", hpRange: "204 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/merc-e200.jpg", segmentOrder: 6, modelFamily: "E-Class" },
  { id: "merc-e300", brandId: "mercedes", name: "E 300", bodyType: BodyType.Sedan, year: 2026, startingPrice: 22000, trimCount: 1, isNew: true, isUpdated: false, specsSummary: { engineRange: "2.0L", hpRange: "258 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/merc-e300.jpg", segmentOrder: 7, modelFamily: "E-Class" },
  { id: "merc-glc200", brandId: "mercedes", name: "GLC 200", bodyType: BodyType.SUV, year: 2026, startingPrice: 17500, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "2.0L", hpRange: "204 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/merc-glc200.jpg", segmentOrder: 8, modelFamily: "GLC" },
  { id: "merc-glc300", brandId: "mercedes", name: "GLC 300", bodyType: BodyType.SUV, year: 2026, startingPrice: 21000, trimCount: 1, isNew: false, isUpdated: false, specsSummary: { engineRange: "2.0L", hpRange: "258 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/merc-glc300.jpg", segmentOrder: 9, modelFamily: "GLC" },
  { id: "merc-gle450", brandId: "mercedes", name: "GLE 450", bodyType: BodyType.SUV, year: 2026, startingPrice: 28000, trimCount: 1, isNew: false, isUpdated: false, specsSummary: { engineRange: "3.0L", hpRange: "367 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/merc-gle450.jpg", segmentOrder: 10, modelFamily: "GLE" },
  { id: "merc-gle53", brandId: "mercedes", name: "AMG GLE 53", bodyType: BodyType.SUV, year: 2026, startingPrice: 38000, trimCount: 1, isNew: false, isUpdated: false, specsSummary: { engineRange: "3.0L", hpRange: "429 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/merc-gle53.jpg", segmentOrder: 11, modelFamily: "GLE" },

  // BMW
  { id: "bmw-3-series", brandId: "bmw", name: "3 Series", bodyType: BodyType.Sedan, year: 2026, startingPrice: 12800, trimCount: 3, isNew: false, isUpdated: true, specsSummary: { engineRange: "2.0L - 3.0L", hpRange: "184 - 374 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/bmw-3-series.jpg" },
  { id: "bmw-5-series", brandId: "bmw", name: "5 Series", bodyType: BodyType.Sedan, year: 2026, startingPrice: 18000, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "2.0L", hpRange: "208 - 245 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/bmw-5-series.jpg" },
  { id: "bmw-x3", brandId: "bmw", name: "X3", bodyType: BodyType.SUV, year: 2026, startingPrice: 16500, trimCount: 2, isNew: true, isUpdated: false, specsSummary: { engineRange: "2.0L", hpRange: "184 - 245 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/bmw-x3.jpg" },
  { id: "bmw-x5", brandId: "bmw", name: "X5", bodyType: BodyType.SUV, year: 2026, startingPrice: 28500, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "3.0L - 4.4L", hpRange: "340 - 530 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/bmw-x5.jpg" },
  { id: "bmw-4-coupe", brandId: "bmw", name: "4 Series Coupe", bodyType: BodyType.Coupe, year: 2026, startingPrice: 16000, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "2.0L - 3.0L", hpRange: "184 - 374 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/bmw-4-coupe.jpg" },

  // Toyota
  { id: "toyota-camry", brandId: "toyota", name: "Camry", bodyType: BodyType.Sedan, year: 2026, startingPrice: 7800, trimCount: 3, isNew: false, isUpdated: true, specsSummary: { engineRange: "2.5L - 3.5L", hpRange: "203 - 301 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/toyota-camry.jpg" },
  { id: "toyota-lc", brandId: "toyota", name: "Land Cruiser", bodyType: BodyType.SUV, year: 2026, startingPrice: 22000, trimCount: 2, isNew: true, isUpdated: false, specsSummary: { engineRange: "3.5L V6", hpRange: "409 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/toyota-lc.jpg" },
  { id: "toyota-rav4", brandId: "toyota", name: "RAV4", bodyType: BodyType.SUV, year: 2026, startingPrice: 9200, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "2.0L - 2.5L", hpRange: "170 - 219 hp", fuelTypes: [FuelType.Petrol, FuelType.Hybrid] }, imageUrl: "/images/cars/toyota-rav4.jpg" },
  { id: "toyota-corolla", brandId: "toyota", name: "Corolla", bodyType: BodyType.Sedan, year: 2026, startingPrice: 5800, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "1.6L - 2.0L", hpRange: "121 - 168 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/toyota-corolla.jpg" },
  { id: "toyota-hilux", brandId: "toyota", name: "Hilux", bodyType: BodyType.Pickup, year: 2026, startingPrice: 10500, trimCount: 2, isNew: false, isUpdated: true, specsSummary: { engineRange: "2.8L Diesel", hpRange: "204 hp", fuelTypes: [FuelType.Diesel] }, imageUrl: "/images/cars/toyota-hilux.jpg" },

  // Lexus
  { id: "lexus-es", brandId: "lexus", name: "ES", bodyType: BodyType.Sedan, year: 2026, startingPrice: 12500, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "2.5L - 3.5L", hpRange: "203 - 302 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/lexus-es.jpg" },
  { id: "lexus-rx", brandId: "lexus", name: "RX", bodyType: BodyType.SUV, year: 2026, startingPrice: 19500, trimCount: 2, isNew: true, isUpdated: false, specsSummary: { engineRange: "2.4L Turbo", hpRange: "275 - 366 hp", fuelTypes: [FuelType.Petrol, FuelType.Hybrid] }, imageUrl: "/images/cars/lexus-rx.jpg" },
  { id: "lexus-nx", brandId: "lexus", name: "NX", bodyType: BodyType.SUV, year: 2026, startingPrice: 14000, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "2.5L", hpRange: "203 - 239 hp", fuelTypes: [FuelType.Petrol, FuelType.Hybrid] }, imageUrl: "/images/cars/lexus-nx.jpg" },
  { id: "lexus-is", brandId: "lexus", name: "IS", bodyType: BodyType.Sedan, year: 2026, startingPrice: 14500, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "2.0L - 5.0L", hpRange: "241 - 472 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/lexus-is.jpg" },

  // Porsche
  { id: "porsche-911", brandId: "porsche", name: "911", bodyType: BodyType.Coupe, year: 2026, startingPrice: 32000, trimCount: 2, isNew: false, isUpdated: true, specsSummary: { engineRange: "3.0L Flat-6", hpRange: "394 - 450 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/porsche-911.jpg" },
  { id: "porsche-cayenne", brandId: "porsche", name: "Cayenne", bodyType: BodyType.SUV, year: 2026, startingPrice: 27000, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "3.0L - 4.0L", hpRange: "353 - 474 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/porsche-cayenne.jpg" },
  { id: "porsche-macan", brandId: "porsche", name: "Macan", bodyType: BodyType.SUV, year: 2026, startingPrice: 20000, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "2.0L - 2.9L", hpRange: "265 - 380 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/porsche-macan.jpg" },
  { id: "porsche-taycan", brandId: "porsche", name: "Taycan", bodyType: BodyType.Sedan, year: 2026, startingPrice: 30000, trimCount: 2, isNew: true, isUpdated: false, specsSummary: { engineRange: "Electric", hpRange: "408 - 530 hp", fuelTypes: [FuelType.Electric] }, imageUrl: "/images/cars/porsche-taycan.jpg" },

  // Changan
  { id: "changan-cs75", brandId: "changan", name: "CS75 Plus", bodyType: BodyType.SUV, year: 2026, startingPrice: 4500, trimCount: 2, isNew: false, isUpdated: true, specsSummary: { engineRange: "1.5L - 2.0L", hpRange: "181 - 233 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/changan-cs75.jpg" },
  { id: "changan-cs55", brandId: "changan", name: "CS55 Plus", bodyType: BodyType.SUV, year: 2026, startingPrice: 3800, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "1.5L", hpRange: "181 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/changan-cs55.jpg" },
  { id: "changan-alsvin", brandId: "changan", name: "Alsvin", bodyType: BodyType.Sedan, year: 2026, startingPrice: 3200, trimCount: 2, isNew: true, isUpdated: false, specsSummary: { engineRange: "1.5L", hpRange: "105 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/changan-alsvin.jpg" },
  { id: "changan-unit", brandId: "changan", name: "Uni-T", bodyType: BodyType.SUV, year: 2026, startingPrice: 5000, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "1.5L - 2.0L", hpRange: "181 - 233 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/changan-unit.jpg" },

  // Haval
  { id: "haval-h6", brandId: "haval", name: "H6", bodyType: BodyType.SUV, year: 2026, startingPrice: 5500, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "1.5L - 2.0L", hpRange: "169 - 211 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/haval-h6.jpg" },
  { id: "haval-jolion", brandId: "haval", name: "Jolion", bodyType: BodyType.SUV, year: 2026, startingPrice: 4200, trimCount: 2, isNew: true, isUpdated: false, specsSummary: { engineRange: "1.5L", hpRange: "150 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/haval-jolion.jpg" },
  { id: "haval-dargo", brandId: "haval", name: "Dargo", bodyType: BodyType.Pickup, year: 2026, startingPrice: 6500, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "2.0L", hpRange: "211 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/haval-dargo.jpg" },

  // MG
  { id: "mg-hs", brandId: "mg", name: "HS", bodyType: BodyType.SUV, year: 2026, startingPrice: 5200, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "1.5L - 2.0L", hpRange: "162 - 231 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/mg-hs.jpg" },
  { id: "mg-zs", brandId: "mg", name: "ZS", bodyType: BodyType.SUV, year: 2026, startingPrice: 3800, trimCount: 2, isNew: false, isUpdated: true, specsSummary: { engineRange: "1.5L", hpRange: "106 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/mg-zs.jpg" },
  { id: "mg-5", brandId: "mg", name: "MG5", bodyType: BodyType.Sedan, year: 2026, startingPrice: 3500, trimCount: 2, isNew: false, isUpdated: false, specsSummary: { engineRange: "1.5L", hpRange: "112 - 162 hp", fuelTypes: [FuelType.Petrol] }, imageUrl: "/images/cars/mg-5.jpg" },
  { id: "mg-4", brandId: "mg", name: "MG4 Electric", bodyType: BodyType.Hatchback, year: 2026, startingPrice: 7500, trimCount: 2, isNew: true, isUpdated: false, specsSummary: { engineRange: "Electric", hpRange: "170 - 245 hp", fuelTypes: [FuelType.Electric] }, imageUrl: "/images/cars/mg-4.jpg" },
];
