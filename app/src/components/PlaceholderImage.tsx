...
function SedanSilhouette() {
  return (
    <>
      <path d="M10 42 L20 42 L25 28 L42 22 L78 22 L95 28 L100 42 L110 42 L110 48 L10 48 Z" fill="#94A3B8" />
...
function SUVSilhouette() {
  return (
    <>
      <path d="M10 42 L18 42 L22 24 L38 16 L82 16 L96 24 L100 42 L110 42 L110 48 L10 48 Z" fill="#94A3B8" />
...
function HatchbackSilhouette() {
  return (
    <>
      <path d="M10 42 L18 42 L22 30 L15 28 L15 42 L10 42 Z" fill="#94A3B8" />
      <path d="M10 42 L15 42 L15 28 L40 22 L78 22 L95 28 L100 42 L110 42 L110 48 L10 48 Z" fill="#94A3B8" />
...
function CoupeSilhouette() {
  return (
    <>
      <path d="M10 44 L20 44 L24 32 L50 24 L85 24 L98 32 L102 44 L110 44 L110 48 L10 48 Z" fill="#94A3B8" />
...
function PickupSilhouette() {
  return (
    <>
      <path d="M10 42 L18 42 L22 24 L38 18 L58 18 L62 24 L62 42 L10 42 Z" fill="#94A3B8" />
      <path d="M62 42 L62 30 L108 30 L108 42 L110 42 L110 48 L10 48 L10 42 Z" fill="#94A3B8" />
...
function ConvertibleSilhouette() {
  return (
    <>
      <path d="M10 44 L20 44 L24 34 L40 30 L80 30 L98 34 L102 44 L110 44 L110 48 L10 48 Z" fill="#94A3B8" />
...
function VanSilhouette() {
  return (
    <>
      <path d="M10 42 L14 42 L14 16 L18 14 L90 14 L98 20 L102 42 L110 42 L110 48 L10 48 Z" fill="#94A3B8" />
